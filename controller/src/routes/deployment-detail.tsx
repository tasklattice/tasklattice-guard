...
export function DeploymentDetailPage() {
  ...
  const versionQuery = useQuery({
    queryKey: queryKeys.guardrailVersion(deployment?.guardrail_id ?? "", deployment?.guardrail_version ?? 0),
