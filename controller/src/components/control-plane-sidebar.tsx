...
import { Activity, Cable, CircleHelp, FlaskConical, History, LayoutDashboard, LibraryBig, ListChecks, Rocket, ScrollText, Server, Settings, ShieldCheck } from "lucide-react";
